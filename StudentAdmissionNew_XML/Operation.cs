        ...
        { 
            ...
            do{
                ...
                public static void  Registration()
              {
                ...
                Console.Write("Enter the Student's Physics Mark  : ");
                int physics=int.Parse(Console.ReadLine());
                Console.Write("Enter the Student's Chemistry Mark   : ");
                int chemistry=int.Parse(Console.ReadLine());
                Console.Write("Enter the Student's Maths Mark  : ");
                int maths=int.Parse(Console.ReadLine());
                StudentDetail student1=new StudentDetail(studentName,fatherName,dob,gender,physics,chemistry,maths);
                studentList.Add(student1); 
            ...
            static  bool CheckEligibility()
            {
                foreach(StudentDetail student in studentList)
                {
                    if(student.StudentId==currentUser.StudentId)
                    {
                        ...
                        {
                        double average=(student.Physics+student.Chemistry+student.Maths)/3.0;
                        if(average>75.0)
                        {
                            return true;
                        }
